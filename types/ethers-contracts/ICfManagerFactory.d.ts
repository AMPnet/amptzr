...
interface ICfManagerFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ICfManagerFactory extends BaseContract {
  ...
  interface: ICfManagerFactoryInterface;
